...
export default function TravelBlogProject() {
	const projectInfo = {
		title: "Travel Blog - Interactive Travel Website",
		description:
			"A dynamic travel blog website featuring advanced CSS animations, 3D model integration, and comprehensive DBMS functionality. The site offers an immersive travel experience with dynamic content management and full responsiveness across all devices.",
		techStack: [
			"HTML5",
			"CSS3",
			"JavaScript",
		...
		features: [
			...
			"3D model integration for immersive experience",
			"Dynamic content management system",
			"Database integration for travel posts",
			"Fully responsive design",
			"Interactive travel destination showcase",
		],
		images: [
			{ src: travelProfile, alt: "Travel Blog Profile", size: "large" },
			{ src: screenshot1, alt: "Homepage with 3D Models", size: "medium" },
			{ src: screenshot2, alt: "Travel Destinations", size: "medium" },
			{ src: screenshot3, alt: "Interactive Gallery", size: "small" },
			{ src: screenshot4, alt: "Blog Posts", size: "small" },
			{ src: screenshot5, alt: "Mobile Responsive", size: "small" },
		],
	};
