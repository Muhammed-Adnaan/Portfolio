...
import aduitcode from "./assets/images/project-pics/aduitcode/aduitProfile.webp";
		...
		<div className="pixelify-sans bg-[#00234b] min-h-screen w-full flex flex-col justify-start items-center p-8 md:p-[100px] font-inter">
			...
			<div className="w-full  grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
				{projects.map((project) => (
					...
					>
						<div className="group bg-gray-900 rounded-lg shadow-lg overflow-hidden flex flex-col h-full transform transition-transform hover:scale-105 duration-300">
							{/* Project Image */}
							<div className="relative w-full p-4">
								{" "}
								{/* Added padding for the inner image card look */}
								<div className="h-32 bg-gray-700 rounded-md overflow-hidden flex items-center justify-center hover:scale-105 duration-500">
									{" "}
									...
									<img
										...
										loading="lazy"
										decoding="async"
										className="max-w-full max-h-full object-contain object-center" // Use object-contain to fit image within bounds
										onError={(e) => {
							...
							<Link to={project.to}>
								<div className="p-6 flex-grow flex flex-col">
									<h3 className="text-[#7CFC7C] text-2xl font-bold mb-3 group-hover:text-yellow-400 duration-300">
										{" "}
